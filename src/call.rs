...
use crate::{c, Plugin, Context, to_cstring};
...
//    }
    T::new(&Context { handle: plugin_handle });
    1
}

pub unsafe fn hexchat_plugin_deinit<T>(
    _plugin_handle: *mut c::hexchat_plugin,
) -> c_int where T: Plugin
{
